...
const Work = () => {
  ...
  return (
    <motion.section initial={{opacity:1}} animate={{opacity:1, transition:{delay:2.4, ease:'easeIn', duration:0.4} }} className='min-h-[80vh] flex flex-col justify-center py-12 xl:py-0'>
